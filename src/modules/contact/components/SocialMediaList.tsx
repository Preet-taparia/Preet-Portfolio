    ...
    <div className='space-y-5 pb-2'>
      ...
      <div className='flex flex-col justify-between gap-3 md:flex-row'>
        {SOCIAL_MEDIA?.map((item, index: number) => (
          <Button
            className={clsx(
              'flex w-full text-lg items-center justify-center transition-all duration-300 hover:scale-105 md:w-1/5 border border-neutral-200 py-3 focus:outline-none dark:border-neutral-700',
              item?.className,
            )}
            key={index}
