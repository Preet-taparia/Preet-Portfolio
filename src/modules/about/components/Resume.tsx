...
const Resume = () => {
  const RESUME_URL =
    'https://docs.google.com/document/d/1LVSqiVgiBKC3Hsp818cxHeJZu-goc9mihtTy4TX2H68/export?format=pdf';
  ...
  return (
    <div className='space-y-5'>
      ...
      <GoogleDocsEmbed src='https://docs.google.com/document/d/1LVSqiVgiBKC3Hsp818cxHeJZu-goc9mihtTy4TX2H68/edit?usp=sharing' />
    </div>
  );
};
